...
3. **setup** - Candidate details form (name, email, ID, phone)
4. **analysis** - AI analysis of resume/JD
5. **interview** - Q&A session with proctoring
6. **report** - Final evaluation report
